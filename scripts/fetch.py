...
retry slots try again. Provisional points (points: "p",
...
def run(args):
    ...
    if args.force:
        ...
        if last_closed_gw < gw_number - 1:
            ...
            # or not FPL ever sets its data_checked flag. fetch_type is
            # "gw_closure" even though the current GW is also active —
            # intentional; the label is informational.
